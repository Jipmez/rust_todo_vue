...
impl Store {
    ...
    pub async fn add_todo_return_all(&self, title: String) -> Result<Vec<Todo>, sqlx::Error> {
        let todos = query_as!(
            Todo,
            r#"--sql
               with inserted as (
    ...
    pub async fn delete_todo_return_all(&self, id: i32) -> Result<Vec<Todo>, sqlx::Error> {
        let todos = query_as!(
            Todo,
            r#"--sql
              with deleted as (
    ...
    pub async fn update_todo_return_all(
        &self,
        id: i32,
        title: String,
        completed: bool,
